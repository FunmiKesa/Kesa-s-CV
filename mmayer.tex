...
\geometry{left=1cm,right=10cm,marginparwidth=9.0cm,marginparsep=0.5cm,top=1cm,bottom=1cm}
...
\begin{document}
\name{Oluwafunmilola Kesa}
\tagline{Software Engineer / Data Scientist}

\personalinfo{%
  % Not all of these are required!
  % You can add your own with \printinfo{symbol}{detail}
  \email{kesaoluwafunmilola@gmail.com}
  \phone{+44-7907-753087}
%  \mailaddress{Address, Street, 00000 County}
  \location{London, United Kingdom}
%  \homepage{marissamayr.tumblr.com/}
%  \twitter{@marissamayer}
  \linkedin{https://www.linkedin.com/in/kesaoluwafunmilola/}
%   \github{github.com/funmikesa} % I'm just making this up though. 
...
\cvevent{Research Fellow}{Data Science for Social Good, Imperial College}{Jun 2019 -- Present}{London, United Kingdom}
\begin{itemize}
...
\cvevent{Co-founder/CTO}{Sorterbox}{Mar 2016 -- Present}{Lagos, Nigeria}
\begin{itemize}
...
\cvevent{Machine Learning Consultant}{Future Corporation}{Jan 2019 -- May 2019}{Kigali, Rwanda}
\begin{itemize}
...
\cvevent{Research Scientist Intern}{IBM Research Africa}{Aug 2018 -- Sep 2018}{Nairobi, Kenya}
\begin{itemize}
...
\cvevent{Machine Learning Intern}{Teletracking}{Aug 2018 -- Sep 2018}{Kigali, Rwanda}
\begin{itemize}
...
\cvevent{Software Developer}{AppZone Group}{Feb 2015 -- Sep 2016}{Lagos, Nigeria}
\begin{itemize}
